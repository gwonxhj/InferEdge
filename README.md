...
| Jetson operation quick-scan registry | 96-frame and 5-minute rows with `Operation Quick Scan Summary`, queue/deadline/fallback markers, and Lab preservation context | [`Latest Jetson Quick-Scan Registry`](docs/agent_runtime_e2e_demo.md#latest-jetson-quick-scan-registry) ([한국어: 최근 Jetson quick-scan marker 재현](docs/agent_runtime_e2e_demo.ko.md#최근-jetson-quick-scan-marker-재현)) |
...
| Operation pressure | `Operation Quick Scan Summary`, `Operation Quick Scan` column, `Operation Quick Scan Raw Marker`, `reviewer_focus_operation_quick_scan`, `Operation quick scan`, `Reviewer operation quick scan`, `compact queue/deadline/fallback operation markers`, `Orchestrator queue/deadline/fallback markers`, `Queue pressure reasons`, `queue_pressure_reason`, `queue_pressure_reason=queue_backlog_threshold_exceeded`, `max_total_queue_depth`, `max_total_queue_depth=7`, `fallback_count`, `deadline_missed_count` |
...
| Latest Jetson quick-scan registry summary | [`Operation Quick Scan Summary`](docs/agent_runtime_e2e_demo.md#latest-jetson-quick-scan-registry) ([한국어: 최근 Jetson quick-scan marker 재현](docs/agent_runtime_e2e_demo.ko.md#최근-jetson-quick-scan-marker-재현)) |
