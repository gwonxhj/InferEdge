...
grep -q '"evidence_index_boundary_summary"' "$OUTPUT_DIR/agent_runtime_quick_scan_registry.json"
grep -q '"all_runs_match": true' "$OUTPUT_DIR/agent_runtime_quick_scan_registry.json"
grep -q '"evidence_index_boundary"' "$OUTPUT_DIR/agent_runtime_quick_scan_registry.json"
...
grep -q "reviewer navigation context" "$BUNDLE_DIR/00_evidence_index.md"
grep -q "do not make the index a Lab report owner" "$BUNDLE_DIR/00_evidence_index.md"
grep -q "not a Lab report owner or source contract" "$BUNDLE_DIR/00_evidence_index.md"
grep -q "not as a new source contract" "$BUNDLE_DIR/00_evidence_index.md"
...
grep -q "Evidence index boundary: role=reviewer_navigation_metadata" "$OUTPUT_DIR/agent_runtime_quick_scan_registry.md"
grep -q "lab_report_owner=False" "$OUTPUT_DIR/agent_runtime_quick_scan_registry.md"
...
grep -q "raw quick-scan marker labels appear" "$OUTPUT_DIR/agent_runtime_quick_scan_registry.md"
grep -q "reviewer-navigation bug" "$OUTPUT_DIR/agent_runtime_quick_scan_registry.md"
