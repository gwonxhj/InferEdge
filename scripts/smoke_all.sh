...
require_runtime_intelligence_report_markers() {
  ...
  require_marker "$gate_summary" "review_path_artifact_gate_summary: artifact gate summary reference row validated"
  ...
  require_marker "$ci_summary" "review_path_artifact_gate_summary: artifact gate summary reference row validated"
...
require_agent_runtime_edgeenv_markers() {
  ...
  require_marker "$index_json" "edgeenv_runtime_operation_summary_label"
  require_marker "$index_json" "operation_summary: mode=timeout_threshold_exceeded"
  require_marker "$index_json" "operation_summary_label"
  require_marker "$index_json" "lab_report_operation_summary_label"
  require_marker "$index_json" "operation_summary: mode=device_local_starter"
  ...
  require_marker "$index_md" "edgeenv_runtime_operation_summary_label"
  require_marker "$index_md" "operation_summary: mode=timeout_threshold_exceeded"
  require_marker "$index_md" "operation_summary_label"
  require_marker "$index_md" "lab_report_operation_summary_label"
  require_marker "$index_md" "operation_summary: mode=device_local_starter"
