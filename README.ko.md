...
묶는 기준, PR `Summary` / `Tests` 기록, 최종 상태 확인, local checkout
safety, optional branch cleanup, diagnostic escape-hatch flag 경계를
...
| [Final Submission Rehearsal](docs/final_submission_rehearsal.md) | clean-clone 제출 rehearsal와 현재 reviewer delta |
